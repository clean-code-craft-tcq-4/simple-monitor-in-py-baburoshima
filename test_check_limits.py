...
#21 to 24	  0.1 to 2.25	    0.11 to 0.14	LOW_WARNING
...
#temparature limit tests
  ...
  print("-------------------------------")
  assert(check_limits.battery_is_ok((42, 70, 0.7),"GERMAN") is True) # normal
  print("-------------------------------")
  assert(check_limits.battery_is_ok((42.75, 70, 0.7),"ENG") is True) # high warning
  print("-------------------------------")
